...
* acquire_refresh_token fix
  "#5":https://github.com/2potatocakes/google_storage/pull/5
  --"Karl Entwistle":https://github.com/karlentwistle
* Updated authorization_url and updated Authorization header 
  to use 'Bearer xxx', now appears to be working again.
