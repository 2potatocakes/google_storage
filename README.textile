...
Find "release-specific documentation":http://rubydoc.info/gems/google_storage 
online, or generate prerelease documentation directly from source using

bc.. $ git clone git://github.com/2potatocakes/google_storage.git
$ cd google_storage
$ bundle install
$ bundle exec yard server --reload

p. and view generated docs as you code at 
"http://localhost:8808":http://localhost:8808 .


h2. MIT License

Copyright (C) 2011 by Lucas Hills. See {file:LICENSE}.
